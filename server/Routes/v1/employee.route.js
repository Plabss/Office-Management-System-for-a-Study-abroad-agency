...
const { addEmployeeController,updateRoleController,getAllEmployeesController,getAEmployeeController,assignApplicantController,assignVisaAdminController, getAllEmployeesWithoutPaginationController } = require('../../controller/employee.controller');
